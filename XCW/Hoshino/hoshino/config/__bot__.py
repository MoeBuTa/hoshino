...
###################################
'''---------昵称及网址----------'''
NICKNAME = r'镜华,at,qq=892761997'  # 设置bot的昵称，at，qq=xxxxxxxx处为bot的QQ号,呼叫昵称等同@bot,推荐修改
IP = 'www.moebuta.xyz'  # 修改为你的服务器ip,推荐修改
public_address = 'www.moebuta.xyz:8888'  # 修改为你的服务器ip+端口,推荐修改
